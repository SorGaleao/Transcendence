...
- Trash can only appear in the lagoon, Outer A, Outer B, and Outer C.
- Trash does not appear in Outer D.

## Base values (V1)

- Common fish: 2 gold
- Uncommon fish: 4 gold
- Rare fish: 7 gold
- Epic fish: 12 gold

## Suggested sets

- Local School: 3 different common fish.
- Export Set: 2 uncommon + 1 rare.
- Ocean Trophy: 2 rare + 1 epic.

## Set bonus values (V1)

- Local School: +4 gold
- Export Set: +8 gold
- Ocean Trophy: +15 gold

## Negotiation rules (V1)

- Negotiation is optional and happens in Phase 1.
- Negotiation can happen regardless of player location.
- Allowed trades: fish-for-fish, fish-for-gold, gold-for-gold.
- Suggested limit: one completed negotiation per player per round.
- Trades are immediate and require both players to accept.

## Additional idea

The economy becomes more interesting when players face two conflicting choices: sell quickly to lock in coins, or hold cargo to complete a better set later. This works well in both quick and normal modes.